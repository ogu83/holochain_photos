...
},{"./lib/client/websocket.browser":"ScGw","./lib/client":"ULuE"}],"MCp7":[function(require,module,exports) {
...
},{}],"6kQO":[function(require,module,exports) {
require("whatwg-fetch"),module.exports=self.fetch.bind(self);
},{"whatwg-fetch":"MCp7"}],"7QCb":[function(require,module,exports) {
"use strict";var n=this&&this.__awaiter||function(n,e,t,o){return new(t||(t=Promise))(function(r,i){function c(n){try{a(o.next(n))}catch(e){i(e)}}function u(n){try{a(o.throw(n))}catch(e){i(e)}}function a(n){n.done?r(n.value):new t(function(e){e(n.value)}).then(c,u)}a((o=o.apply(n,e||[])).next())})},e=this&&this.__generator||function(n,e){var t,o,r,i,c={label:0,sent:function(){if(1&r[0])throw r[1];return r[1]},trys:[],ops:[]};return i={next:u(0),throw:u(1),return:u(2)},"function"==typeof Symbol&&(i[Symbol.iterator]=function(){return this}),i;function u(i){return function(u){return function(i){if(t)throw new TypeError("Generator is already executing.");for(;c;)try{if(t=1,o&&(r=2&i[0]?o.return:i[0]?o.throw||((r=o.return)&&r.call(o),0):o.next)&&!(r=r.call(o,i[1])).done)return r;switch(o=0,r&&(i=[2&i[0],r.value]),i[0]){case 0:case 1:r=i;break;case 4:return c.label++,{value:i[1],done:!1};case 5:c.label++,o=i[1],i=[0];continue;case 7:i=c.ops.pop(),c.trys.pop();continue;default:if(!(r=(r=c.trys).length>0&&r[r.length-1])&&(6===i[0]||2===i[0])){c=0;continue}if(3===i[0]&&(!r||i[1]>r[0]&&i[1]<r[3])){c.label=i[1];break}if(6===i[0]&&c.label<r[1]){c.label=r[1],r=i;break}if(r&&c.label<r[2]){c.label=r[2],c.ops.push(i);break}r[2]&&c.ops.pop(),c.trys.pop();continue}i=e.call(n,c)}catch(u){i=[6,u],o=0}finally{t=r=0}if(5&i[0])throw i[1];return{value:i[0]?i[1]:void 0,done:!0}}([i,u])}}},t=this;Object.defineProperty(exports,"__esModule",{value:!0});var o=require("rpc-websockets");require("isomorphic-fetch");var r="/_dna_connections.json",i=5e3;function c(){return fetch(r).then(function(n){return n.json()}).then(function(n){return n.dna_interface.driver.port}).then(function(n){return"ws://localhost:"+n})}function u(t,o,r,i){return void 0===i&&(i=null),n(this,void 0,void 0,function(){return e(this,function(n){return t.ready?[2,Promise.resolve(t.call(o,r))]:[2,new Promise(function(n,e){var c=i?setTimeout(function(){e("Timeout while waiting for ws to connect. method: "+o+", payload: "+JSON.stringify(r))},i):null;t.once("open",function(){clearTimeout(c),t.call(o,r).then(n).catch(e)})})]})})}exports.connect=function(r){return void 0===r&&(r={}),new Promise(function(a,l){return n(t,void 0,void 0,function(){var n,t,s;return e(this,function(e){switch(e.label){case 0:return(t=r.url)?[3,2]:[4,c().catch(function(){return l("Could not auto-detect DNA interface from conductor. Ensure the web UI is hosted by a Holochain Conductor or manually specify url as parameter to connect")})];case 1:t=e.sent(),e.label=2;case 2:return n=t,r.timeout||i,(s=new o.Client(n,r.wsClient)).on("open",function(){return"WS open"}),s.on("close",function(){return"WS closed"}),s.once("open",function(){a({call:function(){for(var n=[],e=0;e<arguments.length;e++)n[e]=arguments[e];return function(e){var t=1===n.length?n[0]:n.join("/");return u(s,t,e,r.timeout)}},callZome:function(n,e,t){return function(o){return u(s,"call",{instance_id:n,zome:e,function:t,args:o},r.timeout)}},close:function(){return s.close()},onSignal:function(n){s.socket.on("message",function(e){if(e){var t=JSON.parse(e);t.signal&&n(t)}})},ws:s})}),[2]}})})})};var a={connect:exports.connect};
},{"rpc-websockets":"TjgW","isomorphic-fetch":"6kQO"}]},{},["7QCb"], "holochainclient")
//# sourceMappingURL=/hc-web-client-0.5.1.browser.min.js.map